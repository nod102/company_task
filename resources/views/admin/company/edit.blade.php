        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('company.update',$result_page->id) }}" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="page_address"
                                    value="{{$result_page->address}}" placeholder="Name" required>
                            </div>
